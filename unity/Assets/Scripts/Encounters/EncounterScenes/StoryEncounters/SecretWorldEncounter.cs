...
class SecretWorldEncounter : FEncounterScene
{
    ...
    protected override void HandleResult()
    {
        ...
        if (!bShowAgain)
        {
            string endDescription =
                ...
                "secret magic of the wind. It will enable you to move faster and allow you to float on the " +
                "breeze as if you were weightless or whatever. Okay, it's done, good luck I guess, try not to let the whole world down.\n\n\n\n\n" +
                "                               oh yeah I don't know watch out for monsters maybe";
    ...
    public override void OnEnter()
    {
        ...
        string displayMessage =
                "A voice rings inside your head... Hello, young human! I am the nature spirit, Jibbora Jabbora. You have shown great character by seeking me out. " +
                "It is clear that you are the Chosen One spoken of in legend. Or at least, you probably are. Well, if not, " +
                "I'm sure you'll do fine. A powerful evil spirit has been sealed away for centuries in a secret grove...\n\n" +
                ...
                "can only be done by the Dawn Crystal. Last I heard, the Dawn Crystal could be found at the very top of a tall " +
                "stone spire to the south of here. That was ages ago, though, so you might have to go searching a bit. " +
                "Once the sword is recharged, you will be able to enter the secret grove where the evil is sealed away, and, " +
                "with a little luck, be able to defeat it once and for all.\n\nWhat? Why go fight it if it's sealed away? Look, " +
                "don't be smart with me, I'm the wise ancient spirit and you're the Chosen One. It's MY job to tell you what " +
                "to do, and it's YOUR job to do it! Just trust me, I don't make the rules, I'm sure there's a very good reason " +
