...
Arrow Keys/WASD to move, Space/Enter to select. + and - will change the volume, and you can use Escape in the main game to bring up a menu that will let you return to the Title screen.
...
sighnoceros, AKA Jim South, AKA me, who did almost everything, this being the first game I have ever made.
...
bagina, AKA J.R. Trimpe, who wrote and composed an amazing completely original soundtrack for the game, which, conveniently, is available for download here: http://www.trimpe.org/survival

Contact Jim South (jim -at- ironpencil.com) with any questions about the game.

Danger Aversion Training: Adventures in Survival Safety was made in Unity using Futile, a code-centric 2D game framework.

Play

http://www.ironpencil.com (Unity Web Player)

http://www.ironpencil.com/ip-datass-win32.zip (Windows Standalone) 